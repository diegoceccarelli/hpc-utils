 ...
 * </pre>
 * 
 * is called a number k of times, so when: <br/>
 * <br/>
 * <code>
 * 	status % k == 0
 * </code>
 * 
 * 
 * @author Diego Ceccarelli, diego.ceccarelli@isti.cnr.it created on 19/lug/2012
 */
public class ProgressLogger {
	...
	/**
	 * Creates a progress logger, the print frequency is initialized using the
	 * system property <code>logat</code>. If logat is not set no progress will
	 * be print.
	 */
	 ...
	 * 
	 * @param logDesc
	 *            the message to print, the string <code>{}</code> will be
	 *            replaced with the number of times that <code>up()</code> has
	 *            been called.
	 * @param logFrequency
	 *            the print frequency.
	 */
