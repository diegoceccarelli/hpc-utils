...
public class FakeBrowser {
	...
	public FakeBrowser(){
		...
		properties.put("User-Agent", "Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.1.11) Gecko/20071127 Firefox/2.0.0.11");
	}
	 ...
	 * @throws IOException if an errors occurs during the fetching.
	 */
	 ...
	 * @param name the name fo the property
	 ...
	 * @throws IOException if an errors occurs during the fetching.
	 */
	public StringBuilder fetchAsString(String url) throws IOException{
		return asString(fetch(url));
	}
	
	
	private StringBuilder asString(Reader r) throws IOException {
